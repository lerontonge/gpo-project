      ...
      <div className='grid md:grid-cols-3 gap-4 sm:grid-cols-1'>
        ...
        <div className='card sm:card-compact  md:card-compact bg-base-100 shadow-xl'>
          ...
          <div className='card-body'>
            ...
            <p>
              The staff have been out since last week, after the Ministry of
              Works failed to correct the problems caused by a leaking roof,
              including the growth and build-up...
            </p>
            <div className='card-actions justify-end'>
              <button className='btn btn-primary'>Read More</button>
            </div>
